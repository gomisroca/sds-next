        ...
        <div className="text-center">
          ...
          {hasInvite ? (
            <a
              ...
              className="group inline-flex items-center gap-3 border border-red-700/50 bg-red-950/25 px-10 py-4 text-sm font-light tracking-[0.25em] text-red-300 uppercase transition-all duration-300 hover:border-red-600/70 hover:bg-red-900/35 hover:text-red-200">
              {/* Discord mark */}
